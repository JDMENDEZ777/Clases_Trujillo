...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonAccordion, 
  ...
  IonToast, IonToggle, IonText } from '@ionic/angular/standalone';
...
@Component({
  selector: 'app-clase2',
  templateUrl: './clase2.page.html',
  styleUrls: ['./clase2.page.scss'],
  standalone: true,
...
export class Clase2Page implements OnInit {
